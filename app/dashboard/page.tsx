  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50/40 text-slate-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-600 transition-all duration-200 hover:border-slate-300 hover:text-slate-900"
                title="Sign out"
              >
                <LogOut size={16} />
                <span>Sign out</span>
      ...
      >
                ...
                className={`
                  ...
                  ${
                    filter === key
                      ...
                      : 'border-white/60 bg-white/70 text-slate-600 backdrop-blur-xl hover:border-slate-200 hover:bg-white'
                  }
                `}
              >
                {icon}
        ...
        <div className="mt-8 overflow-hidden rounded-3xl border border-white/60 bg-white/70 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
